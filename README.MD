...
- База данных: просмотр и редактирование сущностей (accounts, chats, messages, orders, reservations).
- Рассылки: создание кампаний, сегментация получателей, отслеживание статуса отправки.
- Профиль администратора: управление учетными данными и персональными настройками.
...
2. Клонируйте репозиторий:
   ```bash
   https://github.com/AnatolyNeminushy/admin-panel-2.0
   cd <ваш-репозиторий>
   ```
3. Поднимите сервисы:
   ```bash
